				...
				<div class="strand-content">
					...
					<el-form class="filters content-filters" :model="searchParam" :rules="rules" ref="searchParam" label-position="left" label-width="80px">
						<el-form-item class="filter-item filter-item-inline content-filter" label="物料:" prop="materialCode">
							<v-select placeholder-data="请选择物料" key-data="materialCode" :form-data="searchParam" :list-data="materialData"></v-select>
						</el-form-item>
						<el-form-item class="filter-item filter-item-inline content-filter" label="批次:" prop="batch">
							<v-input placeholder-data="请输入批次" key-data="batch" :form-data="searchParam"></v-input>
						</el-form-item>
