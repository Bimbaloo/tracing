 ...
 * @return {void}
 */
Rt.utils.exportJson2Excel = function(XLSX, Blob, FileSaver, oData) {
 ...
 * @return {void}
 */
Rt.utils.exportTable2Excel = function(XLSX, Blob, FileSaver, oElement, sFileName) {
	// 根据table节点生产表。
 ...
 * @return {void}
 */
Rt.utils.downloadHtml = function(element, filename, option) {
	// 将页面转换为图片。
	html2canvas(element, Object.assign(option || {}, {
		onrendered: function(canvas) {
			var sImg = canvas.toDataURL("image/png"),
