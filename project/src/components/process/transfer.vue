    ...
    <div class="router-content">
        <div class="innner-content" :style="styleObject">
            ...
            <h2 class="content-title tableData">
                <span class='table-title'>结转表</span>
...
const url = window.HOST + '/api/v1/trace/operation-detail/turn-inout/by-id'
...
export default {
  ...
  computed: {
    ...
    operationIdList: function () {
      let arr = []
      this.$route.query.operationIdList.forEach(e => {
        arr.push(e.opId)
      })
      let obj = {
        operationIdList: arr || []
  ...
  methods: {
    ...
    requestSucess (oData) {
      ...
      this.filterDate = oData.turnInOutDetailList.filter(el => {
        return (
          el.operationTime >= this.startTime && el.operationTime <= this.endTime
        )
      })
